...
public class ApiClientFragment extends AsyncTask<Void, Void, Boolean> {
    ...
    public ApiClientFragment(BaseFragment activity, String uri, JSONObject request, String action) {
        sURI = uri;
        sAction = action;
        apiBaseFragment = activity;
        jsonRequest = request;
    }
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            apiBaseFragment.onApiResponse(new JSONObject(responseOutput.toString()), sAction);
        } catch (JSONException e) {
            e.printStackTrace();
        }
